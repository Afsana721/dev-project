...
$(document).ready(function(){
    fetch("https://accbucketlists.herokuapp.com/user/piyush/bucket")
...
$('ul').on('click', "li", function(){
    let id = $(this).data('id');
    fetch("https://accbucketlists.herokuapp.com/user/piyush/bucket/" + id, 
          {method: "PUT"}
    )
    .then(()=>{
...
$('ul').on('click', "span", function(){
    ...
    fetch("https://accbucketlists.herokuapp.com/user/piyush/bucket/" + id, {method: "DELETE"})
    .then(() => {
        $(this).parent().remove();
    })
    .catch(err => console.log(err))
